...
public class TravelSalesmanProblem {
    ...
    public void solvePC() {
        ...
        SimpleGA<PermutationChromosome> sga = new SimpleGA<PermutationChromosome>(pop, GENERATION_LIMIT) {
            @Override
            public void evaluateIndividual(Individual<PermutationChromosome> individual) {
