 ...
 */
package jenes.tutorials.problem7;
...
import jenes.tutorials.problem6.KnapsackGA;
...
public class KnapsackLoggedProblem {
    ...
    public KnapsackLoggedProblem(double[] utilities, double[] weights) throws IOException {
        ...
        xlslogge3 = new XLSLogger(new String[]{"LegalHighestScore", "LegalScoreAvg", 
            "LegalScoreDev", "Legals individuals"}, FOLDER + "knapsack3.log.xls", FOLDER + "knapsack3.tpl.xls");
    ...
    public void run() {
        ...
        Group allLegals = stat.getGroup(Population.LEGALS);
